...
InitRoute::register(CONF,0,true);//初始化路由的配置，设置配置时延(0为永不更新)(当打开路由注解时，配置路由和注解路由都会受影响，关闭时，配置路由不受影响[秒出结果]),是否打开注解路由
Guider::register(1);// 注册引导程序,默认成功时返回code为1，todo 添加更多的状态 And。。。
/* 用户常量参见
